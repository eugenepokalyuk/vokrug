...
function Block() {
    return(
        <div>
            ...
            <div className='vokrug-mobile-container uk-margin-large-top uk-padding uk-hidden@l'>
                <div>
                    <div className='uk-align-left uk-dark' style={size760} >
                        <h1 className='uk-text-left vokrug-h2-text uk-margin-large-bottom'>Ответы на вопросы</h1>
                        <hr />
                        <ul data-uk-accordion>
                            <li className="uk-open">
                                <a className="uk-accordion-title vokrug-accordion-header" href="#1">Чем отличается групповая<br />терапия от индивидуальной?</a>
                                <div className="uk-accordion-content uk-margin-remove-top" style={size520}>
                                    <p className='vokrug-accordion-text'>Ut enim ad minim veniam, quis nostrud exercitationullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor reprehenderit.</p>
                                </div>
                                <hr />
                            ...
                            <li>
                                <a className="uk-accordion-title vokrug-accordion-header" href="#2">Сколько стоит и сколько<br />длится встреча?</a>
                                <div className="uk-accordion-content uk-margin-remove-top" style={size520}>
                                    <p className='vokrug-accordion-text'>Ut enim ad minim veniam, quis nostrud exercitationullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor reprehenderit.</p>
                                </div>
                                <hr />
                            ...
                            <li>
                                <a className="uk-accordion-title vokrug-accordion-header" href="#3">Что если мне<br />не понравится?</a>
                                <div className="uk-accordion-content uk-margin-remove-top" style={size520}>
                                    <p className='vokrug-accordion-text'>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat proident.</p>
                                </div>
                                <hr />
                            ...
                            <li>
                                <a className="uk-accordion-title vokrug-accordion-header" href="#3">Могу ли я поменять<br />группу?</a>
                                <div className="uk-accordion-content uk-margin-remove-top" style={size520}>
                                    <p className='vokrug-accordion-text'>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat proident.</p>
                                </div>
                                <hr />
                            ...
                            <li>
                                <a className="uk-accordion-title vokrug-accordion-header" href="#3">Насколько группы<br />конфиденциальны?</a>
                                <div className="uk-accordion-content uk-margin-remove-top" style={size520}>
                                    <p className='vokrug-accordion-text'>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat proident.</p>
                                </div>
                                <hr />
                            ...
                            <li>
                                <a className="uk-accordion-title vokrug-accordion-header" href="#3">Можно ли совмещать<br />групповые встречи<br />с личной терапией?</a>
                                <div className="uk-accordion-content uk-margin-remove-top" style={size520}>
                                    <p className='vokrug-accordion-text'>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat proident.</p>
                                </div>
                                <hr />
