                    ...
                    <div className="uk-tile uk-dark">
                        <div className="uk-inline">
                            ...
                            <div className="uk-position-cover uk-overlay uk-flex uk-flex-center uk-flex-middle">
                                <h4 className="uk-heading-small">Подбираем группы исходя из личностных <br />качеств участников, схожего запроса, опыта <br />и интересов. Если есть особые пожелания <br />к составу группы — сообщите менеджеру <br />и мы обязательно учтем их</h4>
                            </div>
                        </div>
