            ...
            <div>
                <div className='uk-align-center uk-width-1-2@s uk-dark'>
                    ...
                    <ul data-uk-accordion>
                        ...
                        <li>
                            <a className="uk-accordion-title vokrug-accordion-header" href="#3">Можно ли совмещать групповые встречи с личной терапией?</a>
                            <div className="uk-accordion-content">
                                <p className='vokrug-accordion-text'>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat proident.</p>
                            </div>
                            <hr />
                        ...
                        <p className='uk-text-meta uk-margin-remove vokrug-faqs-text'>Остались вопросы? Напишите нам в любом</p>
                        <p className='uk-text-meta uk-margin-remove vokrug-faqs-text'>мессенджере - мы ответим в течение 5 минут.</p>

                        <div>
                            <a href="#1" className="uk-margin-small-right vokrug-icons-hover">
                                ...
                                {/* <img src={icon_wh} alt="telegram icon" width="48" /> */}
                            </a>
                            <a href="#1" className="uk-margin-small-right vokrug-icons-hover">
                                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                {/* <img src={icon_vk} alt="vk icon" width="48" /> */}
                            </a>
                            <a href="#1" className='vokrug-icons-hover'>
                                ...
                                {/* <img src={icon_tg} alt="whatsapp icon" width="48" /> */}
                            </a>
                        </div>
