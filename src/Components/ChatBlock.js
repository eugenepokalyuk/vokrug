                    ...
                    <div className="uk-card-body uk-padding-small">
                        ...
                        <div className="guest uk-grid-small uk-flex-bottom uk-flex-left" data-uk-grid>
                            <div className="uk-width-auto">
                                <div className="uk-card uk-card-body uk-card-small uk-card-default vokrug-card-default uk-border-rounded">
                        ...
                        <div className="me uk-grid-small uk-flex-bottom uk-flex-right uk-text-right" data-uk-grid>
                            <div className="uk-width-auto">
                                <div className="uk-card uk-card-body uk-card-small uk-card-primary vokrug-card-primary uk-border-rounded">
